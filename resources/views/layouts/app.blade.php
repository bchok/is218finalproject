                    ...
                    @else
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="position:relative; padding-left:40px">
                                <img src="/uploads/pictures/{{Auth::user()->picture}}" style="width:25px; height:25px; position:absolute; top:10px; left:10px; border-radius:25%">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ url('/viewusers') }}"><i class="fa fa-btn fa-user"></i> View Users</a></li>
